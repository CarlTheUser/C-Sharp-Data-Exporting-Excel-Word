...
namespace ConsoleApp1
{
    class Program
    {
        ...
        class Person
        {
            private static readonly DateTime NowCache = DateTime.Now;
            ...
            public Person()
            {
                bool flag = ((Id = ++counter) & 1) == 0;
                SomeProp = flag ? SomeEnum.SomeValue : SomeEnum.SomeValue1;
                Birthdate = new DateTime(1990 + rnd.Next(1, 24), rnd.Next(1, 13), rnd.Next(1, 29));
            }

            [FieldDisplay("Person Number #")]
            ...
            public SomeEnum SomeProp { get; set; }

            public int Age  => (int)NowCache.Subtract(Birthdate).TotalDays / 365;
